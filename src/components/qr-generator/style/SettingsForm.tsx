...
export const SettingsForm = ({ onChange, settings }: SettingsFormProps) => {
  const form = useForm<FormValues>({
    defaultValues: {
      ...
      dotColor: 'color' in settings.dotsOptions ? settings.dotsOptions.color : "#000000",
      cornersSquareStyle: settings.cornersSquareOptions?.type ?? "square",
      cornersSquareColor: 'color' in settings.cornersSquareOptions ? settings.cornersSquareOptions.color : "#000000",
      cornersDotStyle: settings.cornersDotOptions?.type ?? "dot",
      cornersDotColor: 'color' in settings.cornersDotOptions ? settings.cornersDotOptions.color : "#000000",
      background: 'color' in settings.backgroundOptions ? settings.backgroundOptions.color : "#ffffff",
