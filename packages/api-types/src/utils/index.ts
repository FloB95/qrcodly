import { TQrCodeContent, TQrCodeContentType, TVCardInput, TWifiInput } from '../schemas/QrCode';
// import vCardFactory from 'vcards-js';

export function convertVCardObjToString(_vCardInput: TVCardInput): string {
