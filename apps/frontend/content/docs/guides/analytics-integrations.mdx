...
<Callout type="info">
	Analytics integrations require a **Pro Plan**. [View pricing](/plans) to learn more about
	upgrading.
</Callout>
...
<Callout type="info">
	All IP addresses are anonymized before being sent to any provider. The last octet of IPv4
	addresses is zeroed, and IPv6 addresses are truncated. This helps reduce identifiability and
	supports privacy requirements such as GDPR.
</Callout>
