...
>(({ className, ...props }, ref) => (
	<ToastPrimitives.Close
		ref={ref}
		className={cn(
			"text-primary-foreground absolute top-2 right-2 rounded-md p-1 group-[.destructive]:text-red-300 hover:text-white group-[.destructive]:hover:text-red-50 focus:ring-2 focus:outline-none group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
			className,
		)}
		toast-close=""
		{...props}
