...
export const env = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_STRIPE_ADDON_DOMAIN_PRICE_ID_MONTHLY: z.string(),
		NEXT_PUBLIC_STRIPE_ADDON_DOMAIN_PRICE_ID_ANNUAL: z.string(),
	...
	runtimeEnv: {
		...
		NEXT_PUBLIC_STRIPE_ADDON_DOMAIN_PRICE_ID_MONTHLY:
			process.env.NEXT_PUBLIC_STRIPE_ADDON_DOMAIN_PRICE_ID_MONTHLY,
		NEXT_PUBLIC_STRIPE_ADDON_DOMAIN_PRICE_ID_ANNUAL:
			process.env.NEXT_PUBLIC_STRIPE_ADDON_DOMAIN_PRICE_ID_ANNUAL,
