...
import AbstractRepository from '@/core/domain/repository/AbstractRepository';
import { type ISqlQueryFindBy } from '@/core/interface/IRepository';
import configTemplate, { TConfigTemplate } from '../entities/ConfigTemplate';
